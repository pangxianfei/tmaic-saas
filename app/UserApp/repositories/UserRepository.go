...
func (r *userRepository) Find(db *gorm.DB, cnd *simple.SqlCnd) (list []UserAppModel.TenantUser) {
	cnd.Find(db, &list)
	return
}

func (r *userRepository) FindOne(db *gorm.DB, cnd *simple.SqlCnd) *UserAppModel.TenantUser {
	ret := &UserAppModel.TenantUser{}
...
func (r *userRepository) FindPageByParams(db *gorm.DB, params *simple.QueryParams) (list []UserAppModel.TenantUser, paging *simple.Paging) {
	return r.FindPageByCnd(db, &params.SqlCnd)
}

func (r *userRepository) FindPageByCnd(db *gorm.DB, cnd *simple.SqlCnd) (list []UserAppModel.TenantUser, paging *simple.Paging) {
	cnd.Find(db, &list)
