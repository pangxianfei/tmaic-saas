...
require (
	gitee.com/pangxianfei/framework v1.1.8
	gitee.com/pangxianfei/library v1.1.2
	gitee.com/pangxianfei/saas v1.0.7
...
require (
	gitee.com/pangxianfei/multiapp v1.0.4 // indirect
